...
class MusicTweetsProducer
  ...
  def artist_tweet_text
    ...
    insert_at = sentence.index(/\s/)

    sentence.insert(insert_at, " #{@artist_names.sample.chomp} ")
...
if __FILE__ == $0
  aws_region = nil
  stream_name = 'music_tweets'
  shard_count = nil
  sleep_between_puts = 0
  timeout = 0
  ...
  producer = MusicTweetsProducer.new(kinesis, stream_name, sleep_between_puts, shard_count)
